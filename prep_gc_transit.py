...
if real_data:
    ...
    data_dirs = ['/data4/paper/HERA19Golden/RawData/2457548',
                 '/data4/paper/HERA19Golden/RawData/2457549',
                 '/data4/paper/HERA19Golden/RawData/2457550',
                 '/data4/paper/HERA19Golden/RawData/2457551',
                 '/data4/paper/HERA19Golden/RawData/2457552',
                 '/data4/paper/HERA19Golden/RawData/2457553',
                 '/data4/paper/HERA19Golden/RawData/2457554',
                 '/data4/paper/HERA19Golden/RawData/2457555']
    uv_ext = 'uvcRP'
else:
    data_dirs = ['/data4/paper/HERA19Golden/Simulation']
    uv_ext = 'uvC'

# what should we use for output? (uvfits, miriad, or uvh5)
output_filetype = 'miriad'
...
def main():
    # check that output file format is valid
    if output_filetype not in ['miriad', 'uvfits', 'uvh5']:
        raise ValueError("output_filetype must be one of miriad, uvfits, or uvh5")
    ...
    for data_dir in data_dirs:
        ...
        miriad_files = [f for f in sorted(os.listdir(os.getcwd())) if re.match(pattern, f) and '.uvh5' not in f]
        ...
        elif output_filetype == 'miriad':
            outfile = 'gc.' + jd + '.{}'.format(uv_ext)
            print("Writing " + outfile + '...')
            uvd.write_miriad(outfile, clobber=True)
        elif output_filetype == 'uvh5':
            outfile = 'gc.' + jd + '.{}.uvh5'.format(uv_ext)
            print("Writing " + outfile + '...')
